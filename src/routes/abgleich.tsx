...
function AbgleichPage() {
  ...
  return (
    <AppShell>
      ...
      <section className="mt-10 max-w-[78ch] rounded-[22px] border border-line bg-card/70 p-5">
        <h2 className="font-serif text-2xl">Drosselau als WFRP-Schauplatz</h2>
        <p className="mt-3 leading-relaxed text-ink-soft">
          Diese Seite ist die Spielleitungsbrücke zwischen Bildheft und Kampagnenverzeichnis. Die Ortsseiten liefern keine fertigen Szenen, sondern belastbare Reibung: Menschen mit Interessen, sichtbare Spuren, Gerüchte mit Wahrheitskern und Räume, in denen eine Entscheidung Konsequenzen hat.
        </p>
      </section>
